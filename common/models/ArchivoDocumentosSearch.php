...
/**
 * ArchivoDocumentosSearch represents the model behind the search form of `common\models\ArchivoDocumentos`.
 */
class ArchivoDocumentosSearch extends ArchivoDocumentos
{
    ...
    public function rules()
    {
        return [
            ...
            [['monto'], 'number'],
            [['datos_registro', 'tipo_descripcion'], 'safe'],
        ];
    }
    ...
    public function search($params)
    {
        ...
        $query->andFilterWhere(['ilike', 'datos_registro', $this->datos_registro])
            ->andFilterWhere(['ilike', 'tipo_descripcion', $this->tipo_descripcion]);
