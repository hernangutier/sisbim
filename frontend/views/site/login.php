           ...
           <div class="login-container">
             <div class="center">
               <h1>
                 ...
                 <span class="red">SISBIM</span>
                 <span class="grey" id="id-text2">-SOFT (Aplicativo)</span>
               </h1>
               <h4 class="blue" id="id-company-text">&copy; PROCURADURÍA GENERAL DEL EDO. BARINAS C.A.</h4>
