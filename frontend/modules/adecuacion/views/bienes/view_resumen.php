...
<div class="container">
  ...
  <div class="btn-toolbar">
    ...
    <div class="btn-group">
      ...
      <a href="<?= Url::to(['/bienes/update','id'=>$model->id]) ?>" class="btn btn-primary">
                              <i class="ace-icon fa fa-pencil-square-o align-top bigger-125"></i>
                              Actualizar
      </a>
      <?php
          if ($model->is_asegurable){
              echo '<a href="' . Url::to(['/bienes/set-seguro','id'=>$model->id,'url'=>Url::current()]) . '" class="btn btn-info">
                                      <i class="ace-icon fa fa-pencil-square-o align-top bigger-125"></i>
                                      Actualizar Poliza
              </a>';
          }
  ...
  <div class="profile-user-info profile-user-info-striped">
                   <div class="profile-info-row">
                    ...
                    <div class="profile-info-row">
                      ...
                      <div class="profile-info-value">
                        <span class="editable" id="username"><?= $model->idlin0->descripcion ?></span>
                      </div>
                    </div>
                    ...
                    <div class="profile-info-row">
                      ...
                      <div class="profile-info-value">
                        <span class="editable" id="username"><?= is_null($model->idcat0) ? 'No Disponible' : $model->idcat0->codsub0->codigo . '-' . $model->codcat0->codigo . ' ' . $model->codcat0->descripcion ?></span>
                      </div>
                    </div>
                    ...
                    <div class="profile-info-row">
                      ...
                      <div class="profile-info-value">
                        <span class="editable" id="username"><?= $model->idclas0->descripcion ?></span>
                      </div>
                    </div>
  ...
  <div class="profile-user-info profile-user-info-striped">
                    <div class="profile-info-row">
                      ...
                      <div class="profile-info-value">
                        <span class="editable" id="username"><?= $model->idUndActual->codsede0->descripcion ?></span>
                      </div>
                    </div>
                    ...
                    <div class="profile-info-row">
                      ...
                      <div class="profile-info-value">
                        <span class="editable" id="username"><?=  $model->idUndActual->descripcion ?></span>
                      </div>
                    </div>
                    ...
                    <div class="profile-info-row">
                      ...
                      <div class="profile-info-value">
                        <span class="editable" id="username"><?= is_null($model->idUndActual->codresp0) ? 'No Disponible' : $model->codUndActual->codresp0->getNombreCompleto()  ?></span>
                      </div>
                    </div>
                    ...
                    <div class="profile-info-row">
                      ...
                      <div class="profile-info-value">
                        <span class="editable" id="username"><?= is_null($model->idresp_directo) ? 'No Disponible' : $model->codrespDirecto->getNombreCompleto() ?></span>
                      </div>
                    </div>
