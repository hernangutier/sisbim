...
<div class="container">
									...
									<div >
										<h1 class="blue lighter smaller">
											...
											Bienvenido al Modulo de Compras
										</h1>
									</div>
									...
									<div class="col-xs-4">
										<div class="box-custom">
											<div class="imagen">
													<a href="<?= Url::to(['proveedores/index'])  ?>"> <img src="../web/images/providers.png" class="imagen" /> </a>
											</div>
											<div class="titulo">
												 	<h3>Proveedores</h3>
											 </div>
									...
									<div class="col-xs-4">
										<div class="box-custom">
											<div class="imagen">
													<a href="<?= Url::to(['fact-cxp/create'])  ?>"> <img src="../web/images/cesta.png" class="imagen" /> </a>
											</div>
											<div class="titulo">
												 	<h3>Comprar</h3>
											 </div>
