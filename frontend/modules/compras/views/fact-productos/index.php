                              ...
                              'buttons' => [
                                'update' => function ($url, $model, $key) {
                                    return Html::a('<span class="btn btn-xs btn-primary"><i class="ace-icon fa fa-refresh bigger-120"></i></span> ',
                                        Url::to(['fact-productos/update','id'=>$model->id]), [
                ...
                [
                                ...
                                'buttons' => [
                                  'copy' => function ($url, $model, $key) {
                                      return Html::a('<span class="btn btn-xs btn-success"><i class="ace-icon fa fa-files-o bigger-120"></i></span> ',
                                          Url::to(['fact-productos/copy','id'=>$model->id]), [
                                          'id' => 'activity-index-link',
                                          'title' => Yii::t('app', 'Crear Mediante Copia'),
