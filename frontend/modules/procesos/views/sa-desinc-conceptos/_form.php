...
/* @var $model common\models\SaDesincConceptos */
/* @var $form yii\widgets\ActiveForm */
?>

<?= ($model->isNewRecord) ? '<div class="widget-box widget-color-green" ><div class="widget-header">
	<h4 class="widget-title">Nuevo Concepto de Desincorporación</h4>
</div>' : '<div class="widget-box widget-color-blue2" > <div class="widget-header">
	<h4 class="widget-title">Actualizar Concepto de Desincorporación : ' . $model->descripcion . '</h4>
</div>' ?>
