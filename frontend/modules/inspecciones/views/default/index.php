...
<div class="container">
									...
									<div >
										<h1 class="blue lighter smaller">
											...
											Bienvenido al Modulo de División de Inspeccion...
										</h1>
									</div>
									...
									<div class="col-xs-4">
										<div class="box-custom">
											<div class="imagen">
													<a href="<?= Url::to(['div-inspecciones/create'])  ?>"> <img src="../web/images/unidades.png" class="imagen" /> </a>
											</div>
											<div class="titulo">
									...
									<div class="col-xs-4">
										<div class="box-custom">
											<div class="imagen">
													<a href="<?= Url::to(['div-inspecciones/index'])  ?>"> <img src="../web/images/users.png" class="imagen" /> </a>
											</div>
											<div class="titulo">
